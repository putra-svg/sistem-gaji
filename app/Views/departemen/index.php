...
<head>
    ...
    <style>
        body {
            ...
            margin-left: 260px; /* Cocokkan dengan ukuran sidebar */
            overflow-x: hidden;
            color: #333;
        }
...
<body>
            ...
            <tbody>
                <?php foreach ($departemen as $dept): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/departemen/edit/<?= $dept['id']; ?>" class="btn btn-info btn-sm me-2">Edit</a>
                            <button 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus departemen <strong id="deptName"></strong>?</p>
                </div>
    ...
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('confirmDeleteBtn').href = `/departemen/delete/${id}`;
