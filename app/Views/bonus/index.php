...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="/bonus/create" class="btn btn-primary">Tambah Data</a>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($bonus as $item): ?>
                    <tr>
                        ...
                        <td><?= $item['jumlah_bonus']; ?></td>
                        <td>
                            <a href="/bonus/edit/<?= $item['id']; ?>" class="btn btn-info btn-sm me-2">Edit</a>
                            <button 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus bonus karyawan <strong id="deptName"></strong>?</p>
                </div>
    ...
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('confirmDeleteBtn').href = `/bonus/delete/${id}`;
