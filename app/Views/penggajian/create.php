    ...
    <div class="container mt-5">
        ...
        <form action="/penggajian/store" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="gaji_pokok" name="gaji_pokok" placeholder="Rp. 0" oninput="formatRupiah(this)" required>
            </div>
            <div class="mb-3">
                <label for="tunjangan" class="form-label">Tunjangan</label>
                <input type="text" class="form-control" id="tunjangan" name="tunjangan" placeholder="Rp. 0" oninput="formatRupiah(this)" required>
            </div>
