...
<body>
            ...
            <tbody>
                <?php foreach ($karyawan as $karyawan): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/karyawan/edit/<?= $karyawan['id']; ?>" class="btn btn-info btn-sm me-2">Edit</a>
                            <button 
                                class="btn btn-danger btn-sm" 
                                onclick="confirmDelete(<?= $karyawan['id']; ?>, '<?= $karyawan['nama_karyawan']; ?>')">
                                Delete
                            </button>
                        </td>
                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus karyawan <strong id="deptName"></strong>?</p>
                </div>
    ...
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('confirmDeleteBtn').href = `/karyawan/delete/${id}`;
