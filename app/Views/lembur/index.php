...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="/lembur/create" class="btn btn-primary">Tambah Data</a>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($lembur as $l): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/lembur/edit/<?= $l['id']; ?>" class="btn btn-info btn-sm me-2">Edit</a>
                            <button 
                                class="btn btn-danger btn-sm" 
                                onclick="confirmDelete(<?= $l['id']; ?>, '<?= $l['nama_karyawan']; ?>')">
                                Delete
                            </button>
                        </td>
                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus data lembur untuk <strong id="deptName"></strong>?</p>
                </div>
    ...
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('confirmDeleteBtn').href = `/lembur/delete/${id}`;
